...
from .adv_vqa_datamodule import AdversarialVQADataModule
from .adv_vqa_only_datamodule import AdversarialVQAOnlyDataModule
...
_datamodules = {
    ...
    "adv_vqa": AdversarialVQADataModule,
    "adv_vqa_only": AdversarialVQAOnlyDataModule,
}
