from vlmo.datasets import AdversarialVQAOnlyDataset
from .datamodule_base import BaseDataModule
from collections import defaultdict


class AdversarialVQAOnlyDataModule(BaseDataModule):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)

    @property
    def dataset_cls(self):
        return AdversarialVQAOnlyDataset
    ...
    #     answer_type_labels = self.val_dataset.table["answer_type"].to_pandas().tolist()
